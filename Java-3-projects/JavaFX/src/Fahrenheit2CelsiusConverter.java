...
public class Fahrenheit2CelsiusConverter extends Application {
    ...
    public void start(Stage stage){
        ...
        pickScaleFrom.getItems().setAll("Fahrenheit", "Celsius");
        pickScaleTo.getItems().setAll("Fahrenheit", "Celsius");
        ...
        convertButton.setOnAction(event -> {
            ...
            try{
                ...
                a.setContentText("This is not a valid temperature.");
                a.showAndWait();
            }             
        });
